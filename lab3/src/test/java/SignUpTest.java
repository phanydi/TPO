...
public class SignUpTest {
  ...
  public void signUp() throws InterruptedException {
    ...
    {
      WebDriverWait wait = new WebDriverWait(driver, 10);
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(text(),\'Registrieren\')]")));
    }
    ...
    {
      WebDriverWait wait = new WebDriverWait(driver, 10);
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@alt=\'GMX FreeMail\']")));
    }
    Thread.sleep(2000);
    driver.findElement(By.xpath("//img[@alt=\'GMX FreeMail\']")).click();
    Thread.sleep(10000);
  }
}
