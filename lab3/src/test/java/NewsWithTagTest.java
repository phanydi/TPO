...
public class NewsWithTagTest {
  ...
  public void newsWithTag() {
    ...
    {
      WebDriverWait wait = new WebDriverWait(driver, 10);
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(text(),\'US-Wahl 2020\')]")));
    }
    driver.findElement(By.xpath("//a[contains(text(),\'US-Wahl 2020\')]")).click();
  }
}
